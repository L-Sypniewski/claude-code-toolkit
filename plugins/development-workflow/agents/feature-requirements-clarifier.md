...
tools: AskUserQuestion, mcp__sequentialthinking__sequentialthinking, Write
color: purple
model: sonnet
---
...
Use `requirements-clarification` skill for:
- Question templates by category
- "WHEN + WHEN NOT" patterns
- Option formatting best practices
...
See `requirements-clarification` skill for:
