...
Apply this systematic framework using sequential thinking for complex cases:
...
- If sequential thinking unavailable: Proceed with standard architectural analysis
