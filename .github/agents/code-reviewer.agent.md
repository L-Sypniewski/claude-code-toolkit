...
- Trigger: After significant code is written or modified (new features, major refactoring, critical components)
...
- If code search fails: Continue review with available context
- Proceed with standard code review methodology
