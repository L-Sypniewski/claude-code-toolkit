...
- 10 Claude Code skills for coding standards, patterns, workflow orchestration, and C# .NET development
...
- C# and .NET development best practices (SOLID, async/await, EF Core, ASP.NET Core)
